...
try:
    ...
    try:
        # Try DPA4 style detection (Triton 3.x / newer PyTorch)
        triton.runtime.driver.active.get_current_target()
        TRITON_AVAILABLE = True
    except (AttributeError, Exception):
        # Triton 2.2.0 doesn't have driver.active.get_current_target().
        # Fall back to checking if CUDA is available and triton imports work.
        # This is sufficient for Triton 2.2.0 on CUDA systems.
