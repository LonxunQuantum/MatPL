...
SCRIPT_BASE="matpl-2025.3"
SCRIPT_NAME="${SCRIPT_BASE}-update${UPDATE_N}"

rm -rf *part_a* ${SCRIPT_NAME}.sh.tar.gz MatPL-2025.3.tar.gz MatPL-2025.3.tar.gz.base64 ${SCRIPT_NAME}.sh
# 打包环境
...
cp matpl-2025.3.sh.template ${SCRIPT_NAME}.sh
cat MatPL-2025.3.tar.gz.base64 >> ${SCRIPT_NAME}.sh
# 创建时间戳文件
...
# copy file
TARGET_DIR="/share/public/PWMLFF_test_data/matpl-pack/2025.3-gpu"
